...
# Overall Health Trends chart: keep the requested KPI cards, but show only
# weight, body fat %, muscle mass %, and water % as chart series.
replace_once(
...
# Fat mass | Direct muscle mass % | Fat-free mass | BMR
replace_once(
